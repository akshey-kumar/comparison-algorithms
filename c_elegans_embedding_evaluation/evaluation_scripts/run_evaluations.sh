...
for worm_num in 0 1 2 3 4
do
    for algorithm in 'BunDLeNet_win_1' # 'PCA' 'tsne' 'autoencoder' 'ArAe' 'BunDLeNet' 'cebra_h' # 'PCA_time_delay_embedding' 'autoencoder_time_delay_embedding' 'ArAe_time_delay_embedding' 'tsne_time_delay_embedding' 'cebra_h_time_delay_embedding' 'LDA_time_delay_embedding' 'BunDLeNet_linear'
    do
